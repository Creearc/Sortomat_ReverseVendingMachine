...
components['camera'].red_region = [100, 520, 200, 500]
components['camera'].red_gamma = 3.5
components['camera'].red_max = 10

components['camera'].blue_region = [120, 520, 200, 500]
components['camera'].blue_gamma = 1.5
